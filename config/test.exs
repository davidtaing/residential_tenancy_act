...
config :residential_tenancy_act, ResidentialTenancyAct.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "residential_tenancy_act_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :residential_tenancy_act, ResidentialTenancyActWeb.Endpoint,
  ...
  secret_key_base: "JMbh8pmomk2RI41tm1spK/Rq612ck4UllvefbwTjOQh0iNIGZq5WWBj2uQ1AiRHM",
  server: false

# In test we don't send emails
config :residential_tenancy_act, ResidentialTenancyAct.Mailer, adapter: Swoosh.Adapters.Test
